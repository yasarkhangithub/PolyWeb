...
//		FilterProcessor filterProcess = new FilterProcessor();
//		filterProcess.processFilter(arg0);
		
//		ExprList expList = arg0.getExprs();
//		
//		for (Expr expr : expList) {
//			
//			ExprFunction expFunc = expr.getFunction();
//			
//			List<Expr> fArgList = expFunc.getArgs();
...
//				
//				System.out.println("[fff] " + expVar + " -> " + expOp + " -> " + expValue);
//			}
//			
////			for (Expr exprF : fArgList) {
////				if(!exprF.isFunction()) {
////					String expVar = expFunc.getVarName();
////					String expOp = expFunc.getOpName();
////					String expValue = expFunc.getArg(2).toString();
////					
////					System.out.println("[fff] " + expVar + " -> " + expOp + " -> " + expValue);
////				}
////				System.out.println("isfunction: " + exprF.isFunction());
////				System.out.println("Function Args: " + exprF.toString() + "  == " + expFunc.getOpName());
////			}
//			
...
//					System.out.println("[Vistor Expression Var]: " + arg0.toString());
//					
//				}
//				
//				@Override
//				public void visit(NodeValue arg0) {
//					System.out.println("[Vistor Node Value]: " + arg0.toString());
//					
//				}
//				
//				@Override
//				public void visit(ExprFunctionOp arg0) {
//					System.out.println("[Vistor Function OP]: " + arg0.toString());
//					
//				}
//				
//				@Override
//				public void visit(ExprFunctionN arg0) {
//					System.out.println("[Vistor Function N]: " + arg0.toString());
//					
//				}
//				
//				@Override
//				public void visit(ExprFunction3 arg0) {
//					System.out.println("[Vistor Function 3]: " + arg0.toString());
//					
//				}
//				
//				@Override
//				public void visit(ExprFunction2 arg0) {
//					System.out.println("[Vistor Function 2]: " + arg0.toString());
//					
//				}
//				
//				@Override
//				public void visit(ExprFunction1 arg0) {
//					System.out.println("[Vistor Function 1]: " + arg0.toString());
//					
//				}
//				
//				@Override
//				public void visit(ExprFunction0 arg0) {
//					System.out.println("[Vistor Function 0]: " + arg0.toString());
//					
//				}
//			});
//			
